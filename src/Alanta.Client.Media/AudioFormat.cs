...
namespace Alanta.Client.Media
{
	public class AudioFormat : IEquatable<AudioFormat>
	{
		...
		{
			return string.Format("SamplesPerSecond:{0}; MillisecondsPerFrame:{1}; Channels:{2}; BitsPerSample:{3}", SamplesPerSecond, MillisecondsPerFrame, Channels, BitsPerSample);
		}
